...
async function setup() {
  ...
  await db.executeMultiple(`
    ...
    CREATE TABLE IF NOT EXISTS clinics (
      id            TEXT PRIMARY KEY,
      reqvet_org_id TEXT NOT NULL UNIQUE,
      name          TEXT NOT NULL,
      notes         TEXT,
  ...
  const consultations = [
    {
      ...
      vet_name: 'Dr. Martin',
      motif: 'Boiterie postérieure gauche depuis 3 jours',
    },
    {
      id: 'CONSULT-002',
      patient_name: 'Luna',
      ...
      vet_name: 'Dr. Martin',
      motif: 'Vaccination annuelle et bilan de santé',
    },
    {
      id: 'CONSULT-003',
      patient_name: 'Max',
      ...
      vet_name: 'Dr. Lefèvre',
      motif: 'Grattage intense — suspicion de dermatite atopique',
    },
    {
      id: 'CONSULT-004',
      patient_name: 'Plume',
      ...
      vet_name: 'Dr. Martin',
      motif: 'Anorexie depuis 24h et abattement',
    },
  ];
